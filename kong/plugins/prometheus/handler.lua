...
function prometheus_plugin:new()
    ...
    -- Stat Objects
    local generic_stats = { "protocol", "host", "port", "path", "status", "remote_addr", "api_id", "consumer_id", "consumer_name", "consumer_custom_id", "api_name" }
    local entity_stats = { "api_id", "consumer_id", "consumer_name", "consumer_custom_id", "api_name" }
...
function prometheus_plugin:log(plugin_conf)
    ...
    local api_name = (stats.api and stats.api.name or 'global')
    local consumer_username = (stats.consumer and stats.consumer.username or 'anonymous')
    local consumer_custom_id = (stats.consumer and stats.consumer.custom_id or 'anonymous')
